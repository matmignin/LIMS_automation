...
SearchBar_Click({Type:"Mouse",Action:"Left",Actual:1,ClickCount:1,RestorePOS:1,Wait:2,WindowWait:2,Comment:"Mouse Click",Match:1,OffsetX:5,OffsetY:5,Area:"ahk_exe WFICA32.EXE",Bits:"000Dzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzy03zzzzzzzy03zzzzzzzy03zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzw000U",Ones:527,Zeros:73,Threshold:290,W:20,H:30})
}
WinActivate,%Title%
...
Global
WinGetActiveTitle,Title
SearchBar_Click({Type:"Mouse",Action:"Left",Actual:1,ClickCount:2,RestorePOS:0,Wait:3,WindowWait:2,Comment:"Mouse Click",Match:1,OffsetX:-30,OffsetY:14,Area:"ahk_exe WFICA32.EXE",Bits:"000000000000000000000000000000000000000000000000004001k00C001s007001k00T0000000000008",Ones:22,Zeros:484,Threshold:290,W:22,H:23})
}
WinActivate,%Title%


;~ Do Not Change From Here
Searchbar_Click(Actions*){
