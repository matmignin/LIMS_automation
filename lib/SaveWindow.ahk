...
SaveWindow_Save(){
 ...
 if !IsObject(file)
 {
  ...
  line:= SaveWindow_SectionHeader() . CrLf
  file.Write(line)
  ...
  Loop, %id%
  {
	...
	{
		; if This_title contains Visual Studio Code
		; 	This_title:="Visual Studio Code"
		; if This_title contains Mozilla Firefox
			; This_title:="ahk_exe firefox.exe"
		; if This_title contains | Vitaquest Workspace
