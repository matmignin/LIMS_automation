...
SetKeyDelay, 1,5 return
#Include Functions.AHK
return
;#Include LMS\GUI_ProductTable.ahk
#IfWinActive, Edit Product - \\Remote 
	Mbutton::Product_Tab_EditProduct(ProductCode)

#ifwinactive, Edit Formulation - \\Remote  
	Mbutton::Product_Tab_tabletsizeMenu()
		
	
#ifwinactive, Composition - \\Remote   
	
	Mbutton::run, LMS\GUI_ProductTable.ahk
