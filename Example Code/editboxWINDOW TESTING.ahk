...
Gui, +Resize +Toolwindow +AlwaysOnTOp +owner +HwndGUIID ; Make the window resizable.
Gui, Add, Edit,x0 y0 +Resize vEditBox WantTab, %Clipboard%
gui, margin,0,0
gui, add, button, x0 y0 h0 w0 hidden default gEditBoxButtonOK, OK
Gui, Show,Autosize, Clipboard
CurrentFileName := ""  ; Indicate that there is no current file.
winSet, Transparent, 100, EditBox
return

FileNew:
GuiControl,, EditBox  ; Clear the Edit control.
return
